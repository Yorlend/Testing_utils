...
## В репозитории находятся скрипты автоматизации создания лаб и тестирования, а также тестовая лаба, на которой можно проверить работоспособность
 - скрипт `test.sh` отвечает за непосредственное тестированние;
